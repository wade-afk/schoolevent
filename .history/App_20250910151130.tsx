                ...
                <main className="space-y-8">
                    <div className="relative w-full max-w-lg mx-auto">
                        ...
                        <button
                            ...
                            className="absolute top-2 right-2 bg-black bg-opacity-70 hover:bg-opacity-90 text-white p-2 rounded-lg transition-all duration-200 flex items-center gap-2"
                            aria-label="태극기 전체 화면으로 보기"
                        >
                            <FullscreenIcon className="w-4 h-4" />
                            <span className="text-xs hidden sm:inline">전체화면</span>
                        </button>
                    </div>
